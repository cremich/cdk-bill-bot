...
| <code><a href="#@cremich/cdk-bill-bot.CostAndUsageReportProps.property.name">name</a></code> | <code>string</code> | *No description.* |
...
##### `name`<sup>Required</sup> <a name="name" id="@cremich/cdk-bill-bot.CostAndUsageReportProps.property.name"></a>
